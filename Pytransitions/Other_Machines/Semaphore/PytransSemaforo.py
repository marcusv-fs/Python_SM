...
####################### Init and util Functions ####################### 
    def __init__(self):
        ...
        ####################### Draw State Machine ######################
        try:
            self.get_graph().draw('Pytransitions/Other_Machines/Semaphore/Data/PytransSemaphore1.cgimage', prog='dot')
            #Generates the digraph textual description, ignore the error
        except:
            pass
        
        self.get_graph().draw('Pytransitions/Other_Machines/Semaphore/Data/PytransSemaphore.canon', prog='dot')
        
        self.get_graph().draw('Pytransitions/Other_Machines/Semaphore/Data/PytransSemaphore.plain', prog='dot')

        self.get_graph().draw('Pytransitions/Other_Machines/Semaphore/Data/PytransSemaphore.png', prog='dot')
...
machine = Semaphore()
file = open("Pytransitions/Other_Machines/Semaphore/Data/trace.txt", "w")
machine.run()
file.close()