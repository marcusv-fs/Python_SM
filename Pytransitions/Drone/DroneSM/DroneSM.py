...
####################### Init and util Functions ####################### 
    def __init__(self):
        ...
        ####################### Draw State Machine ######################
        self.get_graph().draw('Pytransitions/Drone/DroneSM/Data/DroneSM.canon', prog='dot') 
        self.get_graph().draw('Pytransitions/Drone/DroneSM/Data/DroneSM.png', prog='dot')  
...
####################### Transition Conditions ####################### 
    ...
    def cond_Wait_TurnOn(self):
        if self.start:
            configFile = "Pytransitions/Drone/DroneSM/Data/config.txt"
...
file = open("Pytransitions/Drone/DroneSM/Data/log_if.txt", "w")
trace = open("Pytransitions/Drone/DroneSM/Data/trace_if.txt", "w")
machine = DroneSM()
machine.run()
file.close()