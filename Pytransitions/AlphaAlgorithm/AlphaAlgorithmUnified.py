...
####################### Init and util Functions ####################### 
    def __init__(self):
        ...
        ####################### Draw State Machine ######################
        self.file = open("Pytransitions/AlphaAlgorithm/Data/MovementAndAvoidance/MovementAndAvoidance_trace.txt", "w")
        self.get_graph().draw('Pytransitions/AlphaAlgorithm/Data/MovementAndAvoidance/MovementAndAvoidance.canon', prog='dot') 
        self.get_graph().draw('Pytransitions/AlphaAlgorithm/Data/MovementAndAvoidance/MovementAndAvoidance.png', prog='dot') 
...
####################### Init and util Functions ####################### 
    def __init__(self):
        ...
        turned = False
        ####################### Draw State Machine ######################
        self.file = open("Pytransitions/AlphaAlgorithm/Data/Turning/Turning_trace.txt", "w")
        self.get_graph().draw('Pytransitions/AlphaAlgorithm/Data/Turning/Turning.canon', prog='dot') 
        self.get_graph().draw('Pytransitions/AlphaAlgorithm/Data/Turning/Turning.png', prog='dot') 
...
####################### Init and util Functions ####################### 
    def __init__(self):
        ...
        ####################### Draw State Machine ######################
        self.get_graph().draw('Pytransitions/AlphaAlgorithm/Data/AlphaAlgorithm/AlphaAlgorithm.canon', prog='dot') 
        self.get_graph().draw('Pytransitions/AlphaAlgorithm/Data/AlphaAlgorithm/AlphaAlgorithm.png', prog='dot')  
